<div class="iil-modale" style="background-color:<?php echo esc_attr( $iil_modale_params->couleur_bg ); ?> ; color:<?php echo esc_attr( $iil_modale_params->couleur_txt ); ?>">
	...
	<form action="" method="post" class="iil-formulaire__inscription" style="background-color:<?php echo esc_attr( $iil_modale_params->couleur_bg ); ?> ;
	 color:<?php echo esc_attr( $iil_modale_params->couleur_txt ); ?>">
